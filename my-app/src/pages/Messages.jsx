...
export default function Messages() {
  ...
  const [messages, setMessages] = useState([
    ...
    { 
      ...
      unread: true,
      thread: [
        { sender: "them", text: "Reminder: Your next shift starts tomorrow at 9AM." }
      ]
    },
    { 
      id: 3, 
      ...
      unread: true,
      thread: [
        { sender: "them", text: "Weather alert: Conditions may change suddenly. Please be prepared." }
      ]
    },
    { 
      id: 4, 
      ...
      unread: true,
      thread: [
        { sender: "them", text: "Your supervisor updated your schedule. Check the app for details." }
      ]
    },
    { 
      id: 5, 
      ...
      unread: true,
      thread: [
        { sender: "them", text: "System Notice: Your profile has been updated successfully." }
      ]
    },
  ]);
        ...
        <div className="bg-gray-200 p-4 rounded-2xl flex flex-col gap-3">
          {messages.map((msg) => (
            <Link
              key={msg.id}
              to={`/chat/${msg.id}`}
              state={{ thread: msg.thread, title: msg.title, messageId: msg.id }}
